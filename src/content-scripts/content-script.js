...
document.addEventListener("keypress", event => {
  ...
  if (
    (isEditable(currentElement) || currentElement.isContentEditable) &&
    currentChar !== " "
  ) {
    ...
    if (
      beforeLastChar != null &&
      beforeLastChar !== " " /* FIXME : test any other blank character ! */
    ) {
      const charCombination = beforeLastChar + currentChar;
